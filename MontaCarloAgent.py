...
class MontaCarloAgenet(Agent):

    def __init__(self, allPlayers, simulationsNum):
       super(self)
       self.simulations_num = simulationsNum
       self.all_players = allPlayers
       self.current_board = None

    def is_end_game(self,id, next_move_dict,first_move):
